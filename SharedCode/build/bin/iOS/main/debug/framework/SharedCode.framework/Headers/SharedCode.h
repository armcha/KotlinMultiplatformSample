...
@class SharedCodeHelloMultiPlatform;
...
__attribute__((swift_name("HelloMultiPlatform")))
@interface SharedCodeHelloMultiPlatform : KotlinBase
...
+ (int32_t)getRandomNumber __attribute__((swift_name("getRandomNumber()")));
@end;
...
+ (int32_t)rand __attribute__((swift_name("rand()")));
@property (class, readonly) NSString *a;
@property (class, readonly, getter=doNewB) int32_t newB;
@end;
